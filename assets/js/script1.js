...
//     console.log(task);
//     var todaysDate = dayjs().format("YYYY-m-dd");
// var taskDate = dayjs(task.deadline).format("YYYY-m-dd");
...
//     getCardColor(task);
//     var taskCard = `<div class="card task-card draggable p-2 m-3"  
//     id="${task.id}"
//     data-task-id="${task.id}" style="width: 18rem;">
//             <div class="card-body">
//                   <h5 class="card-title">Title:${task.title}</h5>
//                  <h6 class="card-subtitle mb-2 text-body-secondary">
//                   Description: ${task.description}</h6>
...
//         zIndex:100,
//         helper: function(e){
//             const original = $(e.target).hasClass("draggable") ? $(e.target) : $(e.target).closest(".draggable");
//             console.log("Orig","draggable",original)
...
//     const id = ui.draggable[0].dataset.taskId
//     const newState = event.target.id
//     console.log(newState, id, "UI",ui,taskList)
//     taskList = taskList.map((task) => {
//         return task.id === id ? { ...task, status: newState } : task;
//     }
//     );
